      ...
      <div className="pass-recovery">
          <form action="" class="fundo-form">
            <div class="content">
              ...
              <input type="password" name="" id="" class="login-entrada marg-bottom-15" placeholder="Nova senha" />
              <input type="password" name="" id="" class="login-entrada marg-bottom-15" placeholder="Confirmar senha" />
              <button className="recupera-botao marg-top-30">Enviar</button>
